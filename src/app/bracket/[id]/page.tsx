...
function roundRank(label: string) {
  ...
  if (value.includes("semi")) return 20;
  if (value.includes("final")) return 30;
  const number = value.match(/\d+/);
  return number ? Number(number[0]) : 50;
}
