...
export function Matchboard({ matches: initialMatches, demo }: { matches: Match[]; demo: boolean }) {
  ...
  return <div className="shell">
    <header><a className="brand" href="/" aria-label="HomeSports"><span className="brand-home"><i>H</i><i>O</i><i>M</i><i>E</i></span><span className="brand-sports">SPORTS</span></a><p>League of Legends esports, ranked by what matters.</p><a className="calendar-link" href="/calendar">CALENDAR</a><div className="pick-count">PICK’EM <b>{savedPicks}</b></div><div className="pulse"><b /> LIVE DATA</div></header>
