...
export function Matchboard({ matches: initialMatches, demo }: { matches: Match[]; demo: boolean }) {
  ...
  return <div className="shell">
    <header><a className="brand" href="/"><img className="brand-logo" src="/homesports-logo-crop.png" alt="HomeSports" /></a><p>League of Legends esports, ranked by what matters.</p><a className="calendar-link" href="/calendar">CALENDAR</a><div className="pick-count">PICK’EM <b>{savedPicks}</b></div><div className="pulse"><b /> LIVE DATA</div></header>
